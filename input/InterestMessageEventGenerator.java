 ...
 * be configured.
 */
public class InterestMessageEventGenerator implements EventQueue {
	...
	//-----------------------------------------
	protected static String[] dataNameList = {"A","B","C","D","E","F","I","J",
			"K","L","M","N","O","P","Q","R","S","T","U","V","W",
			"X","Y","Z"};
	protected static int number_of_dataName = 10; //TODO, need to be set 
	//-----------------------------------------
	 ...
	 */
	public InterestMessageEventGenerator(Settings s){
	 ...
	 */
	protected String drawDataName() {
				
		return dataNameList[rng.nextInt(number_of_dataName - 2)];
	...
	public ExternalEvent nextEvent() {
		...
		//@lyx
		dataName = drawDataName();
		
		/* Create event and advance to next event */
		InterestMessageCreateEvent imce = new InterestMessageCreateEvent(from, to, this.getID(), 
				msgSize, responseSize, this.nextEventsTime, dataName);
