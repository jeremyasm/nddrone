...
public class Message implements Comparable<Message> {
	...
	//lyx
	public void setTo(DTNHost dest) {
		this.to = dest;
	}
	...
	protected void copyFrom(Message m) {
		...
		this.appID = m.appID;
		this.dataName = m.dataName; // add by lyx
...
//	@Override
//	public String toString() {
//		return "Message [from=" + from + ", to=" + to + ", id=" + id + ", size=" + size + ", path=" + path
//				+ ", uniqueId=" + uniqueId + ", timeReceived=" + timeReceived + ", timeCreated=" + timeCreated
//				+ ", initTtl=" + initTtl + ", responseSize=" + responseSize + ", requestMsg=" + requestMsg
//				+ ", properties=" + properties + ", appID=" + appID + ", dataName=" + dataName + "]";
//	}
